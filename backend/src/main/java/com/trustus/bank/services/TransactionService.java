...
public class TransactionService {
    ...
    // Injects the transaction persistence layer.
    public TransactionService(TransactionRepository transactionRepository) {
        this.transactionRepository = transactionRepository;
    }

    // Records a transfer between a customer's own accounts.
    @Transactional
    ...
    // Records an external or employee-initiated transfer between accounts.
    @Transactional
    ...
    // Records cash deposited into an account via the ATM.
    @Transactional
    ...
    // Records cash withdrawn from an account via the ATM.
    @Transactional
    ...
    // Creates and persists a new ledger transaction.
